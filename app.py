...
data = {
    ...
    "services": [
      {
        "name": "Centre d'appel",
        "description": "Nous offrons des services de centre d'appel pour gérer vos communications avec les clients de manière professionnelle et efficace. notre équipe est formée pour répondre à vos besoins spécifiques.",
        "options": [
          {
            "name": "support client 24/7",
            "description": "Attarwij Agency offre un service client disponible 24 heures sur 24, 7 jours sur 7. Les clients peuvent contacter l'agence à tout moment."
          },
          {
            "name": "confirmation téléphonique",
            "description": "Ce service implique la vérification d'informations ou de rendez-vous par téléphone."
          },
          {
            "name": "suivi personnalisé",
            "description": "Cela peut inclure le suivi des demandes, des commandes ou des questions spécifiques, afin de garantir une satisfaction client maximale."
          },
          {
            "name": "assistance multilingue",
            "description": "Pour répondre aux besoins d'une clientèle diversifiée, Attarwij Agency offre un support dans plusieurs langues."
          },
          {
            "name": "suivi des appels et analyse des données",
            "description": "Ces données sont ensuite analysées pour obtenir des insights utiles qui peuvent aider à améliorer les opérations ou les services client."
          },
          {
            "name": "gestion des appels entrants et sortants",
            "description": "Attarwij Agency prend en charge à la fois les appels entrants (des clients vers l'agence) et les appels sortants (de l'agence vers les clients ou partenaires)."
          },
          {
            "name": "réponse rapide et personnalisée",
            "description": "On s'engage à fournir des réponses rapides et adaptées aux besoins spécifiques de chaque client."
          }
        ],
        "type": "service"
      },
        ...
        "options": [
          {
            ...
            "description": "C'est une stratégie où Attarwij collabore avec des influenceurs sur les réseaux sociaux pour promouvoir les produits ou services de ses clients."
          },
          {
            "name": "stratégie de contenu et gestion des réseaux sociaux",
            "description": "Attarwij développe des stratégies de contenu pour ses clients, en créant du contenu pertinent et attractif sur les réseaux sociaux."
          },
          {
            "name": "publicité en ligne (Google Ads, Facebook Ads)",
            "description": "Attarwij gère des campagnes publicitaires en ligne à travers des plateformes telles que Instagram, Facebook, Google."
          },
          {
            "name": "SEO (optimisation pour les moteurs de recherche)",
            "description": "Attarwij optimise le contenu et la structure des sites web de ses clients pour améliorer leur classement dans les résultats des moteurs de recherche comme Google."
          },
          {
            "name": "marketing par courriel",
            "description": "Cela inclut la création de listes de diffusion, la conception de courriels attrayants et pertinents, et l'analyse des performances des campagnes pour optimiser les taux d'ouverture et de conversion."
          },
          {
            "name": "analyse des performances et rapports détaillés",
            "description": "Attarwij surveille et analyse les performances de toutes les activités marketing numériques mises en œuvre pour ses clients. Des rapports détaillés sont fournis régulièrement."
          }
        ],
        "type": "service"
      },
        ...
        "options": [
          {
            ...
            "description": "Cela inclut la conception graphique, l'architecture de l'information et l'ergonomie du site pour assurer une expérience utilisateur optimale."
          },
          {
            "name": "Développement de sites responsives",
            "description": "Les sites développés par Attarwij sont conçus pour être compatibles avec tous les appareils (ordinateurs de bureau, tablettes, smartphones)."
          },
          {
          ...
          },
          {
            ...
            "description": "L'agence optimise le contenu et la structure des sites web pour améliorer leur visibilité dans les résultats des moteurs de recherche comme Google."
          },
          {
            "name": "Maintenance et mises à jour régulières",
            "description": "Attarwij assure la maintenance continue des sites web, y compris la résolution de problèmes techniques, la sauvegarde régulière des données et la mise à jour des logiciels et des plugins."
          }
        ],
        "type": "service"
      },
        ...
        "options": [
          {
            ...
            "description": "Attarwij développe des stratégies de contenu sur mesure pour ses clients, en alignant les objectifs commerciaux avec les besoins et les intérêts de leur public cible."
          },
          {
...
model =  genai.GenerativeModel(
   ...
   system_instruction=f"you're a chatbot at ATTARWIJ AGENCY, help users in a friendly way and answer their questions based on this json code: {data}.make your answers brief and direct,to ease the users experience, and make it simple and easier for the users to understand clearly",
)
"""
